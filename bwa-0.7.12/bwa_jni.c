...
JNIEXPORT jint JNICALL Java_BwaJni_bwa_1aln1_1jni (JNIEnv *env, jobject thisObj, jint argc, jobjectArray stringArray, jintArray lenStrings){
	...
	if(temp_stdout == -1){
		fprintf(stderr, "[%s] Error saving stdout: %s\n", __func__,strerror(errno));
	}
...
JNIEXPORT jint JNICALL Java_BwaJni_bwa_1mem_1jni (JNIEnv *env, jobject thisObj, jint argc, jobjectArray stringArray, jintArray lenStrings){
